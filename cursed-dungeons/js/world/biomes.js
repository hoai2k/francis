...
export const DOMAINS = {
  ...
  malevolent_shrine: { skyTop: 0x100000, skyHorizon: 0x7a0a0a, fog: 0x300606, fogDensity: 0.02, hemiSky: 0xff6a5a, hemiGround: 0x200000, hemiI: 1.0, sun: 0xff4a3a, sunI: 1.2, grade: { tint: [1.15, 0.9, 0.88], lift: [0.03, 0.0, 0.0], sat: 1.2, contrast: 1.2, vignette: 0.5 }, floor: B.shrine_floor },
