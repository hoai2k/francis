...
// ---------- sky / city ----------
const SKY_KEYS = [
  [0, '#141633', '#3d2b5a', '#e0764a'], [60, '#141633', '#3d2b5a', '#e0764a'], [92, '#0a0612', '#2a1040', '#6a2a9a'],
  [108.3, '#0a0612', '#2a1040', '#8a3aba'], [108.6, '#3a2a38', '#6a5058', '#c0906a'], [DUR, '#2a2230', '#5a4450', '#b0806a'],
];
function skyCols(T) {
...
function drawSky(T) {
  ...
  if (T < 92) { rect(sx - 16, sy - 16, 32, 32, 'rgba(255,190,120,0.25)'); rect(sx - 11, sy - 11, 22, 22, '#ffb070'); rect(sx - 11, sy - 2, 22, 2, '#e0764a'); rect(sx - 11, sy + 4, 22, 1.5, '#e0764a'); }
  // stars
...
const BUILDINGS = [
  { x: -560, w: 70, h: 210, tex: 'concrete', holes: [[36.11, -22]] }, { x: -470, w: 60, h: 160, tex: 'brick', holes: [[35.85, -22]] },
  { x: -390, w: 76, h: 250, tex: 'glass', holes: [[24.0, -60], [35.54, -22]] }, { x: -290, w: 58, h: 140, tex: 'concrete', holes: [[35.46, -22]] },
  { x: -210, w: 64, h: 190, tex: 'brick' }, { x: 110, w: 80, h: 240, tex: 'glass', slice: 30.6 },
  ...
  { x: -700, w: 70, h: 230, tex: 'glass', blast: 45.55 }, { x: -780, w: 60, h: 170, tex: 'concrete' },
];
...
const FIN_X = -60;
const CRATERS = [[-300, 26.15, 40], [0, 17.85, 22], [FIN_X, 108.4, 280]];
